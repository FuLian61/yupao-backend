...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword, String planetCode) {
        ...
        if (count > 0){
            throw new BusinessException(ErrorCode.PARAMS_ERROR,"星球编号编号");
        }
        //2.加密
    ...
    public User userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        // 用户不存在
        if(user == null){
            log.info("user login falied, userAccount cannot match userPassword");
...
//        SortedMap<Integer,Long> indexDistanceMap = new TreeMap<>();
        for (int i = 0 ; i < userList.size(); i++) {
            ...
            // 计算分数
            long distince = AlgorithUtils.minDistance(tagList,userTagList);
            list.add(new Pair<>(user,distince));
        }
        // 按编辑距离由小到大排序
